...
### 7.01
 ...
 - The existing iptables rules before the launch of airmise-ng are now restored upon exiting if modified
...
### 6.21
 ...
 - Fixed error executing airmise-ng after auto-update on some distros
...
### 3.2
 ...
 - Changed version var to airmise-ng_version for future version check (auto-update feature)
