...
function language_strings() {
	...
	et_misc_texts["ENGLISH",8]="airmise-ng. Evil Twin attack captured passwords"
	et_misc_texts["SPANISH",8]="airmise-ng. Contraseñas capturadas en ataque Evil Twin"
	et_misc_texts["FRENCH",8]="airmise-ng. Mots de passe capturés par attaque Evil Twin"
	et_misc_texts["CATALAN",8]="airmise-ng. Contrasenyes capturades amb atac Evil Twin"
	et_misc_texts["PORTUGUESE",8]="airmise-ng. Senhas capturadas no ataque ataque Evil Twin"
	et_misc_texts["RUSSIAN",8]="airmise-ng. Атака Злой Двойник захватила пароли"
	et_misc_texts["GREEK",8]="airmise-ng. Η επίθεση Evil Twin κατέγραψε κωδικούς πρόσβασης"
	et_misc_texts["ITALIAN",8]="airmise-ng. Password catturate con l'attacco Evil Twin"
	...
	et_misc_texts["ENGLISH",19]="airmise-ng. Captive portal Evil Twin attack captured password"
	et_misc_texts["SPANISH",19]="airmise-ng. Contraseña capturada en el portal cautivo del ataque Evil Twin"
	et_misc_texts["FRENCH",19]="airmise-ng. Mot de passe capturé par le portail captif de l'attaque Evil Twin"
	et_misc_texts["CATALAN",19]="airmise-ng. Contrasenya capturada al portal captiu de l'atac Evil Twin"
	et_misc_texts["PORTUGUESE",19]="airmise-ng. Senha capturada no ataque Evil Twin portal cativo"
	et_misc_texts["RUSSIAN",19]="airmise-ng. Атака Злой Двойник + Перехватывающий портал захватили пароль"
	et_misc_texts["GREEK",19]="airmise-ng. Η επίθεση Evil Twin με captive portal κατέγραψε τον κωδικό πρόσβασης"
	et_misc_texts["ITALIAN",19]="airmise-ng. Password catturata nel captive portal dell'attacco Evil Twin"
	...
	wep_texts["ENGLISH",1]="airmise-ng. Captured password during WEP attack"
	wep_texts["SPANISH",1]="airmise-ng. Contraseña capturada en ataque WEP"
	wep_texts["FRENCH",1]="airmise-ng. Mot de passe obtenu lors de l'attaque WEP"
	wep_texts["CATALAN",1]="airmise-ng. Contrasenya capturada en atac WEP"
	wep_texts["PORTUGUESE",1]="airmise-ng. Senha capturada no ataque WEP"
	wep_texts["RUSSIAN",1]="airmise-ng. В атаке WEP захвачен пароль"
	wep_texts["GREEK",1]="airmise-ng. Ο κωδικός πρόσβασης κατά την διάρκεια της επίθεσης WEP"
	wep_texts["ITALIAN",1]="airmise-ng. Password catturata con l'attacco WEP"
	...
	hashcat_texts["ENGLISH",1]="airmise-ng. Decrypted password using hashcat"
	hashcat_texts["SPANISH",1]="airmise-ng. Contraseña desencriptada con hashcat"
	hashcat_texts["FRENCH",1]="airmise-ng. Mot de passe déchiffré avec hashcat"
	hashcat_texts["CATALAN",1]="airmise-ng. Contrasenya desencriptada amb hashcat"
	hashcat_texts["PORTUGUESE",1]="airmise-ng descriptografou a senha usando hashcat"
	hashcat_texts["RUSSIAN",1]="airmise-ng. Пароль расшифрован с использованием hashcat"
	hashcat_texts["GREEK",1]="airmise-ng. Αποκρυπτογραφημένος κωδικός πρόσβασης με χρήση hashcat"
	hashcat_texts["ITALIAN",1]="airmise-ng. Password decifrata con hashcat"

	declare -gA aircrack_texts
	aircrack_texts["ENGLISH",1]="airmise-ng. Decrypted password using aircrack"
	aircrack_texts["SPANISH",1]="airmise-ng. Contraseña desencriptada con aircrack"
	aircrack_texts["FRENCH",1]="airmise-ng. Mot de passe déchiffré avec aircrack"
	aircrack_texts["CATALAN",1]="airmise-ng. Contrasenya desencriptada amb aircrack"
	aircrack_texts["PORTUGUESE",1]="airmise-ng descriptografou a senha usando aircrack"
	aircrack_texts["RUSSIAN",1]="airmise-ng. Пароль расшифрован с использованием aircrack"
	aircrack_texts["GREEK",1]="airmise-ng. Αποκρυπτογραφημένος κωδικός πρόσβασης με χρήση aircrack"
	aircrack_texts["ITALIAN",1]="airmise-ng. Password decifrata con aircrack"
	...
	arr["ENGLISH",6]="                           Welcome to airmise-ng script"
	arr["SPANISH",6]="                           Bienvenid@ a airmise-ng script"
	arr["FRENCH",6]="                            Bienvenue au script airmise-ng"
	arr["CATALAN",6]="                           Benvingut a airmise-ng script"
	arr["PORTUGUESE",6]="                        Bem-vindo ao script airmise-ng"
	arr["RUSSIAN",6]="                           Добро пожаловать в скрипт airmise-ng"
	arr["GREEK",6]="                             Καλωσήρθατε στο airmise-ng"
	arr["ITALIAN",6]="                           Benvenuti a airmise-ng script"
	...
	arr["ENGLISH",11]="Exiting airmise-ng script - See you soon! :)"
	arr["SPANISH",11]="Saliendo de airmise-ng script - Nos vemos pronto! :)"
	arr["FRENCH",11]="Fermeture du script airmise-ng - A bientôt! :)"
	arr["CATALAN",11]="Sortint de airmise-ng script - Ens veiem aviat! :)"
	arr["PORTUGUESE",11]="Saindo do script airmise-ng - Até breve! :)"
	arr["RUSSIAN",11]="Выход из скрипта airmise-ng - До встречи! :)"
	arr["GREEK",11]="Κλείσιμο του airmise-ng - Αντίο :)"
	arr["ITALIAN",11]="Abbandonando airmise-ng script - A presto! :)"
	...
	arr["ENGLISH",73]="airmise-ng script v${airmise-ng_version} developed by :"
	arr["SPANISH",73]="airmise-ng script v${airmise-ng_version} programado por :"
	arr["FRENCH",73]="Le script airmise-ng v${airmise-ng_version} a été programmé par :"
	arr["CATALAN",73]="airmise-ng script v${airmise-ng_version} desenvolupat per :"
	arr["PORTUGUESE",73]="Script airmise-ng v${airmise-ng_version} desenvolvido por :"
	arr["RUSSIAN",73]="скрипт airmise-ng v${airmise-ng_version} создал :"
	arr["GREEK",73]="Το airmise-ng script v${airmise-ng_version} προγραμματίστηκε από :"
	arr["ITALIAN",73]="airmise-ng script v${airmise-ng_version} sviluppato da :"
	...
	arr["ENGLISH",101]="airmise-ng main menu"
	arr["SPANISH",101]="Menú principal airmise-ng"
	arr["FRENCH",101]="Menu principal d'airmise-ng"
	arr["CATALAN",101]="Menú principal airmise-ng"
	arr["PORTUGUESE",101]="Menu principal airmise-ng"
	arr["RUSSIAN",101]="Главное меню airmise-ng"
	arr["GREEK",101]="Αρχικό μενού airmise-ng"
	arr["ITALIAN",101]="Menú principale airmise-ng"
	...
	arr["ENGLISH",163]="When airmise-ng requests you to enter a path to a file either to use a dictionary, a Handshake or anything else, did you know that you can drag and drop the file over the airmise-ng window? In this way you don't have to type the path manually"
	arr["SPANISH",163]="Cuando airmise-ng solicita que introduzcas una ruta a un fichero ya sea para utilizar un diccionario, un Handshake o cualquier otra cosa, ¿sabías que puedes arrastrar y soltar el fichero sobre la ventana de airmise-ng? Así no tendrás que escribir la ruta manualmente"
	arr["FRENCH",163]="Quand airmise-ng demande d'entrer un chemin d'accès vers un fichier soit pour utiliser un dictionnaire, un Handshake ou autre chose, saviez-vous que vous pouvez faire glisser le fichier sur la fenêtre airmise-ng? Donc vous n'avez pas à taper la route manuellement"
	arr["CATALAN",163]="Quan airmise-ng sol·licita que introdueixis una ruta a un fitxer ja sigui per utilitzar un diccionari, un Handshake o qualsevol altra cosa, ¿saps que pots arrossegar i deixar anar el fitxer sobre la finestra de airmise-ng? Així no hauràs d'escriure la ruta manualment"
	arr["PORTUGUESE",163]="Quando a airmise-ng solicita que você insira o caminho de um dicionário, um Handshake ou qualquer outra coisa, você sabia que pode arrastar o arquivo para janela do airmise-ng? Assim você não precisa digitar o caminho manualmente"
	arr["RUSSIAN",163]="Когда airmise-ng просит вас ввести путь до файла, будь то словарь, рукопожатие или что-то ещё, знаете ли вы, что можно захватить этот файл мышкой, перетащить и бросить этот файл прямо в окно airmise-ng? Таким образом вам не придётся вводить путь до файла вручную"
	arr["GREEK",163]="Γνωρίζατε ότι μπορείτε να εισάγετε μονοπάτι για κάποιο αρχείο είτε για να χρησιμοποιήσετε λεξικό, αρχείο Χειραψίας ή οτιδήποτε άλλο, κάνοντας Drag & Drop το αρχείο αυτό στο παράθυρο του airmise-ng; Με αυτόν τον τρόπο δεν χρειάζεται να πλεικτρολογείτε το μονοπάτι χειροκίνητα"
	arr["ITALIAN",163]="Quando airmise-ng chiede di introdurre il percorso di un file per utilizzare un dizionario, un Handshake o qualsiasi altra cosa, sapevi che puoi trascinare e rilasciare il file sulla finestra di airmise-ng? Cosí non dovrai digitare manualmente il percorso"
	...
	arr["ENGLISH",191]="${blue_color}airmise-ng can't find the directory path where you have BeEF installed. ${green_color}Do you want to enter it manually? ${normal_color}${visual_choice}"
	arr["SPANISH",191]="${blue_color}airmise-ng no ha podido encontrar la ruta del directorio donde tienes instalado BeEF. ${green_color}¿Quieres introducirla manualmente? ${normal_color}${visual_choice}"
	arr["FRENCH",191]="${blue_color}airmise-ng n'a pas trouvé le dossier qui contient BeEF. ${green_color}Voulez-vous l'indiquer manuellement? ${normal_color}${visual_choice}"
	arr["CATALAN",191]="${blue_color}airmise-ng no ha pogut trobar la ruta del directori on tens instal·lat BeEF. ${green_color}¿Vols introduir-la manualment? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",191]="${blue_color}O airmise-ng não conseguiu encontrar o diretório onde você instalou o BeEF. ${green_color}Você quer inseri-lo manualmente? ${normal_color}${visual_choice}"
	arr["RUSSIAN",191]="${blue_color}airmise-ng не может найти путь к каталогу, где вы установили BeEF. ${green_color}Вы хотите ввести его вручную? ${normal_color}${visual_choice}"
	arr["GREEK",191]="${blue_color}Το airmise-ng δεν μπορεί να βρει το μονοπάτι για τον κατάλογο όπου έχετε εγκαταστημένο το BeEF. ${green_color}Θέλετε να το εισάγετε χειροκίνητα; ${normal_color}${visual_choice}"
	arr["ITALIAN",191]="${blue_color}airmise-ng non ha potuto trovare il percorso della directory in cui è stato installato BeEF. ${green_color}Vuoi inserirlo manualmente? ${normal_color}${visual_choice}"
	...
	arr["ENGLISH",213]="A new version of the script exists (v${airmise-ng_last_version}). It will be downloaded"
	arr["SPANISH",213]="Existe una nueva versión del script (v${airmise-ng_last_version}). Será descargada"
	arr["FRENCH",213]="Une nouvelle version du script est disponible (v${airmise-ng_last_version}). Lancement du téléchargement"
	arr["CATALAN",213]="Hi ha una nova versió dels script (v${airmise-ng_last_version}). Serà descarregada"
	arr["PORTUGUESE",213]="Existe uma nova versão do script (v${airmise-ng_last_version}). Download será iniciado"
	arr["RUSSIAN",213]="Существует новая версия скрипта (v${airmise-ng_last_version}). Она будет загружена"
	arr["GREEK",213]="Υπάρχει νεότερη έκδοση του script (v${airmise-ng_last_version}). Θα κατέβει"
	arr["ITALIAN",213]="Esiste una nuova versione dello script (v${airmise-ng_last_version}). Sarà scaricata"
	...
	arr["ENGLISH",223]="airmise-ng needs root permissions to work. Launch the script as root user or using \"sudo\""
	arr["SPANISH",223]="airmise-ng necesita permisos de root para funcionar. Lanza el script como usuario root o usando \"sudo\""
	arr["FRENCH",223]="airmise-ng a besoin de permissions root pour etre exécuter. Lancez the script en tant que root ou en utilisant \"sudo\""
	arr["CATALAN",223]="airmise-ng necessita permisos de root per funcionar. Llança l'script com a usuari root o utilitza \"sudo\""
	arr["PORTUGUESE",223]="airmise-ng necessita de permissões root para funcionar. Execute o script como root ou usando \"sudo\""
	arr["RUSSIAN",223]="airmise-ng требует для работы прав root. Запустите скрипт как root пользователь или используйте \"sudo\""
	arr["GREEK",223]="Το airmise-ng χρειάζεται root δικαιώματα για να δουλέψει. Ανοίξτε το script ως χρήστης root ή χρησιμοποιήστε \"sudo\""
	arr["ITALIAN",223]="airmise-ng ha bisogno dei permessi di root per l'esecuzione. Lancia lo script come root o usando \"sudo\""
	...
	arr["ENGLISH",401]="The beef package you have installed is not BeEF (Browser Exploitation Framework). You have Beef (Flexible Brainfuck interpreter) installed. Both executables have the same name and can lead to confusion. Uninstall it and install what airmise-ng needs if you want to use that feature. Installation guide: ${beef_installation_url}"
	arr["SPANISH",401]="El paquete beef que tienes instalado no es BeEF (Browser Exploitation Framework). Tienes instalado Beef (Flexible Brainfuck interpreter). Ambos ejecutables se llaman igual y puede dar lugar a confusión. Desinstálalo e instala el que airmise-ng necesita si quieres usar esa característica. Guía de instalación: ${beef_installation_url}"
	arr["FRENCH",401]="Le paquet beef installé n'est pas le bon: Vous avez installé Beef (Flexible Brainfuck interpreter) et vous devez installer BeEF (Browser Exploitation Framework). Les deux ont le même nom et peut induire en erreur. Désinstallez et installez la version dont airmise-ng a besoin si vous souhaitez utiliser cette fonctionnalité. Guide d'installation: ${beef_installation_url}"
	arr["CATALAN",401]="El paquet beef que tens instal·lat no és BeEF (Browser Exploitation Framework). Tens instal·lat Beef (Flexible Brainfuck interpreter). Tots dos executables es diuen igual i pot donar lloc a confusió. Desinstalalo i instal·la el que airmise-ng necessita si vols utilitzar aquesta característica. Guia d'instal·lació: ${beef_installation_url}"
	arr["PORTUGUESE",401]="O pacote beef instalado não é o BeEF (Browser Exploitation Framework). Você instalou Beef (Flexible Brainfuck interpreter). Ambos possuem o mesmo nome e executável o que pode levar a confusão. Desinstale-o e instale o que o airmise-ng precisa se você quiser usar esse recurso. Guia de Instalação: ${beef_installation_url}"
	arr["RUSSIAN",401]="Установленный вами пакет beef не является пакетом BeEF (Browser Exploitation Framework). Вы установили Beef (Flexible Brainfuck interpreter). Оба исполнимых файла имеют одинаковое имя и могут вызвать путаницу. Если вы хотите использовать эту функцию, удалите его и установите тот, который требует airmise-ng. Инструкция по установке: ${beef_installation_url}"
	arr["GREEK",401]="Το πακέτο beef που έχετε εγκαταστημένο δεν είναι το BeEF (Browser Exploitation Framework). Έχετε εγκατεστημένο το Beef (Flexible Brainfuck interpreter). Και τα δύο εκτελέσιμα αρχεία έχουν το ίδιο όνομα και μπορεί να γίνει κάποιο μπέρδεμα. Απεγκαταστήστε το και εγκαταστήστε αυτό που χρειάζεται το airmise-ng, αν θέλετε να χρησιμοποιήσετε αυτή την επιλογή. Οδηγός εγκατάστασης: ${beef_installation_url}"
	arr["ITALIAN",401]="Il pacchetto beef che hai installato non è BeEF (Browser Exploitation Framework). È stato installato Beef (Flexible Brainfuck interpreter). Entrambi gli eseguibili hanno lo nome e può essere fonte di confusione. Disinstallarlo e installare quello di cui ha bisogno airmise-ng se si desidera utilizzare questa funzione. Guida all'installazione: ${beef_installation_url}"
	...
	arr["ENGLISH",413]="airmise-ng fixed the problem. Your BeEF is operational"
	arr["SPANISH",413]="airmise-ng ha solucionado el problema. Tu BeEF está operativo"
	arr["FRENCH",413]="airmise-ng a résolu le problème. BeEF est opérationnel"
	arr["CATALAN",413]="airmise-ng ha solucionat el problema. El teu BeEF està operatiu"
	arr["PORTUGUESE",413]="O airmise-ng corrigiu o problema. Seu BeEF está operacional"
	arr["RUSSIAN",413]="airmise-ng устранил проблему. Ваш BeEF находится в рабочем состоянии"
	arr["GREEK",413]="Το airmise-ng διόρθωσε το πρόβλημα. Το BeEF λειτουργεί κανονικά"
	arr["ITALIAN",413]="airmise-ng ha risolto il problema. Il tuo BeEF è operativo"
	...
	arr["ENGLISH",420]="It has been detected that you are running airmise-ng inside a Docker container. During this attack hostapd is used to create a fake AP. This component often conflicts with network-manager. From inside the container, airmise-ng can't handle it. If you have network-manager installed on your host machine, close it or kill the conflicting processes or you'll get an error. For more information, see the Docker section of the Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["SPANISH",420]="Se ha detectado que estás ejecutando airmise-ng en un contenedor de Docker. En este ataque se utiliza hostapd para crear un falso AP. Este componente suele dar conflicto con network-manager. Desde el contenedor, airmise-ng no puede gestionarlo. Si tienes network-manager instalado en tu máquina host, ciérralo o mata los procesos en conflicto u obtendrás un error. Para más información consulta la sección Docker del Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["FRENCH",420]="Il a été détecté qu'airmise-ng a été lancé depuis un conteneur Docker. Cette attaque à besoin d'hostapd pour créer un Point d'Accès piège. Hostapd a tendance à entrer en conflit avec network-manager et airmise-ng ne peut pas le gérer depuis le conteneur. Si network-manager est installé sur votre machine host, arrêtez ou tuez les processus conflictuels. Dans le cas contraire vous obtiendrez une erreur. Pour plus d'informations, consultez la section Docker de notre Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["CATALAN",420]="S'ha detectat que estàs executant airmise-ng en un contenidor de Docker. En aquest atac s'utilitza hostapd per crear un fals AP. Aquest component sol donar conflicte amb network-manager. Des del contenidor, airmise-ng no pot gestionar-lo. Si tens network-manager instal·lat a la teua màquina host, tanca'l o mata els processos en conflicte u obtindràs un error. Per a més informació consulta la secció Docker del Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["PORTUGUESE",420]="Detectamos que você está executando airmise-ng em um container Docker. Neste ataque é usado hostapd para criar um AP falso. Este componente tende a entrar em conflito com network-manager. A partir do container o airmise-ng não pode controlá-lo. Se você tem network-manager instalado em sua máquina host feche-o, mate os processos conflitantes ou você irá obter um erro. Para mais informações consulte a seção Docker Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["RUSSIAN",420]="Определено, что вы запускаете airmise-ng внутри контейнера Docker. Во время этой атаки для создания поддельной AP используется hostapd. Этот компонент часто конфликтует с network-manager. Изнутри контейнера airmise-ng не может справиться с этим. Если на вашем хост-компьютере установлен network-manager, закройте его или уберите конфликтующие процессы, иначе вы получите сообщение об ошибке. Для получения дополнительной информации см. раздел Docker в Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["GREEK",420]="Εντοπίστηκε πως τρέχετε το airmise-ng μέσα σε Docker container. Κατά τη διάρκεια αυτής της επίθεσης χρησιμοποιείται το hostapd για να δημιουργήσει ψεύτικο AP. Η δημιουργία αυτού κάνει conflicts με τον network-manager. Το airmise-ng δεν μπορεί να το χειριστεί μέσα από το container. Αν υπάρχει ο network-manager εγκατεστημένος στον host-υπολογιστή, κλείστε τον ή διακόψτε τις διεργασίες που κάνουν conflict αλλιώς θα υπάρξουν σφάλματα. Για περισσότερες πληροφορίες, ανατρέξτε στην ενότητα Docker του Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	arr["ITALIAN",420]="È stato rilevato che si sta eseguendo airmise-ng in un contenitore Docker. In questo attacco viene utilizzato hostapd per creare un falso AP. Questo componente tende a creare un conflitto con il network-manager. Dal contenitore, airmise-ng non può gestirlo. Se si dispone di network-manager installato sul computer host, chiuderlo o uccidere i processi in conflitto o ci sará un errore. Per ulteriori informazioni consultare la sezione Docker della nostra Wiki: ${normal_color}${urlgithub_wiki}/Docker"
	...
	arr["ENGLISH",422]="The automatic update has been disabled when airmise-ng is running in a Docker container. If you want to update it, download again the image tagged as \"latest\""
	arr["SPANISH",422]="La actualización automática se ha desactivado cuando airmise-ng se ejecuta en un contenedor de Docker. Si deseas actualizarlo descarga de nuevo la imagen con tag \"latest\""
	arr["FRENCH",422]="La mise à jour automatique est désactivée si airmise-ng s'exécute depuis un conteneur Docker. Si vous voulez le mettre à jour vous devez télécharger l'image avec le label \"latest\""
	arr["CATALAN",422]="L'actualització automàtica s'ha desactivat quan airmise-ng s'executa en un contenidor de Docker. Si vols actualitzar-lo descàrrega de nou la imatge amb tag \"latest\""
	arr["PORTUGUESE",422]="A atualização automática é desativada quando airmise-ng é executado em um container Docker. Se você quiser atualizar faça o download novamente da imagem em \"latest\""
	arr["RUSSIAN",422]="Когда airmise-ng работает в контейнере Docker, то автоматическое обновление отключено,. Если вы хотите обновить программу, то снова загрузите образ отмеченный как \"latest\""
	arr["GREEK",422]="Η διαδικασία της αυτόματης ενημέρωσης είναι απενεργοποιημένη όταν το airmise-ng τρέχει σε Docker container. Εάν θέλετε να το ενημερώσετε, κατεβάστε ξανά το αρχείο με την ετικέτα \"latest\""
	arr["ITALIAN",422]="L'aggiornamento automatico viene disabilitato quando airmise-ng viene eseguito in un contenitore Docker. Se vuoi aggiornarlo scaricare di nuovo l'immagine con il tag \"latest\""
	...
	arr["ENGLISH",436]="The hashcat version you have installed (${hashcat_version}) is greater or equal than ${hashcat_hccapx_version} so you need to convert the capture files to \"hccapx\" format, airmise-ng will do this automatically. To do this you need a converter that is not present on your system (hashcat-utils package), install it to be able to perform this attack"
	arr["SPANISH",436]="La versión de hashcat que tienes instalada (${hashcat_version}) es igual o superior a la ${hashcat_hccapx_version} por lo que es necesario convertir los ficheros de captura a formato \"hccapx\", airmise-ng lo hará automáticamente. Pero para ello hace falta un conversor que no está presente en tu sistema (paquete hashcat-utils), instálalo para poder realizar este ataque"
	arr["FRENCH",436]="La Version d'hashcat installée (${hashcat_version}) est égale ou supérieure à la version ${hashcat_hccapx_version}. Il est nécessaire dans ce cas de convertir les captures au format \"hccapx\", ce que fera automatiquement airmise-ng. Il faut pour cela un convertisseur qui n'est pas installé dans votre système (paquet hashcat-utils). Veuilez l'installer pour effectuer cette attaque"
	arr["CATALAN",436]="La versió de hashcat que tens instal·lada (${hashcat_version}) és igual o superior a la ${hashcat_hccapx_version} pel que cal convertir els fitxers de captura a format \"hccapx\", airmise-ng ho farà automàticament. Però per a això cal un convertidor que no està present al sistema (paquet hashcat-utils), instal·lal per poder realitzar aquest atac"
	arr["PORTUGUESE",436]="A versão do hashcat instalada (${hashcat_version}) é maior ou igual a ${hashcat_hccapx_version}, portanto é necessário convertermos o arquivo de captura para o formato \"hccapx\", airmise-ng fará isso automaticamente. Mas isso requer um conversor que não está instalado no seu sistema (pacote hashcat-utils), instale-o para realizar este ataque"
	arr["RUSSIAN",436]="Установленная версия hashcat (${hashcat_version}) больше или равна ${hashcat_hccapx_version}, поэтому вам нужно конвертировать файлы захвата в формат \"hccapx\", airmise-ng сделает это автоматически. Для этого вам нужен конвертер, которого нет в вашей системе (пакет hashcat-utils), установите его, чтобы иметь возможность выполнить эту атаку"
	arr["GREEK",436]="Η έκδοση του hashcat που έχετε εγκαταστήσει (${hashcat_version}) είναι ίδια ή νεότερη από την έκδοση ${hashcat_hccapx_version}, άρα το airmise-ng θα μετατρέψει τα αρχεία καταγραφής σε \"hccapx\" για να συνεχιστεί η διαδικασία. Για να επιτευχθεί αυτό χρειάζεστε ένα μετατροπέα που δεν υπάρχει στο σύστημά σας (περιέχεται στο πακέτο hashcat-utils), εγκαταστήστε το για να εκτελέσετε αυτήν την επίθεση"
	arr["ITALIAN",436]="La versione di hashcat installata (${hashcat_version}) è uguale o superiore alla ${hashcat_hccapx_version} quindi è necessario convertire i file di acquisizione al formato \"hccapx\", airmise-ng lo fará automaticamente. Peró questo richiede un convertitore che non è presente nel sistema (pacchetto hashcat-utils), installalo per eseguire questo attacco"
	...
	arr["ENGLISH",438]="We are looking for translators to other languages. If you want to see airmise-ng in your native language and you also know english, contact us. More information at: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["SPANISH",438]="Buscamos traductores para otros idiomas. Si quieres ver airmise-ng en tu lengua materna y además sabes inglés, contáctanos. Más información en: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["FRENCH",438]="Nous recherchons des traducteurs pour d'autres langues. Si vous voulez voir airmise-ng dans votre langue maternelle et que vous connaissez l'anglais contactez-nous: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["CATALAN",438]="Busquem traductors per a altres idiomes. Si vols veure airmise-ng en la teva llengua materna i més saps anglès, contacta'ns. Més informació a: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["PORTUGUESE",438]="Procuramos tradutores para outros idiomas. Se você quiser ver airmise-ng em sua língua nativa e também sabe inglês, por favor contacte-nos. Mais informações: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["RUSSIAN",438]="Мы ищем переводчиков на другие языки. Если вы хотите увидеть airmise-ng на своем родном языке, и вы знаете английский язык, пожалуйста, свяжитесь с нами. Дополнительная информация: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["GREEK",438]="Ψάχνουμε μεταφραστές για την υποστήριξη περισσότερων γλωσσών. Αν θέλετε να χρησιμοποιείτε το airmise-ng στη μητρική σας γλώσσα, αλλά ξέρετε και αγγλικά, παρακαλούμε επικοινωνήστε μαζί μας. Περισσότερες πληροφορίες: ${normal_color}${urlgithub_wiki}/Contributing"
	arr["ITALIAN",438]="Cerchiamo traduttori per le altre lingue. Se volete vedere airmise-ng nella vostra lingua madre e conoscete anche l'inglese, non esitate a contattarci. Per maggiori informazioni: ${normal_color}${urlgithub_wiki}/Contributing"
	...
	arr["ENGLISH",442]="If you install ccze you'll see some parts of airmise-ng in a colorized way with better aspect. It's not a requirement or a dependency, but it will improve the user experience"
	arr["SPANISH",442]="Si instalas el paquete ccze podrás ver algunas partes de airmise-ng colorizadas y con mejor aspecto. No es un requerimiento ni una dependencia, pero mejorará la experiencia de usuario"
	arr["FRENCH",442]="L'installation du paquet ccze améliore le rendu graphique d'airmise-ng. Ce n'est pas un prérequis mais un petit plus pour rendre l’utilisation d'airmise-ng plus agréable."
	arr["CATALAN",442]="Si instal·les el paquet ccze podràs veure algunes parts de airmise-ng coloriçades i amb millor aspecte. No és un requeriment ni una dependència, però millorarà l'experiència d'usuari"
	arr["PORTUGUESE",442]="Se você instalar o pacote ccze poderá ver algumas partes do airmise-ng coloridas e mais bonitas. Não é uma exigência nem uma dependência, mas melhora a experiência do usuário"
	arr["RUSSIAN",442]="Если вы установите ccze, то некоторые цветные элементы airmise-ng будут выглядеть лучше. Это не требование или зависимость, но это улучшит работу пользователя"
	arr["GREEK",442]="Αν εγκαταστήσετε το ccze θα δείτε μερικά κομμάτια του airmise-ng, πολύχρωμα με καλύτερη εμφάνιση. Δεν είναι απαραίτητο dependency, αλλά θα βελτιώσει την εμπειρία του χρήστη"
	arr["ITALIAN",442]="Se installi il pacchetto ccze vedrai alcune parti di airmise-ng colorate e più belle. Non è un requisito né una dipendenza, ma migliorerà l'esperienza dell'utente"
	...
	arr["ENGLISH",447]="5.  Set permanently airmise-ng's language to the current one"
	arr["SPANISH",447]="5.  Cambiar permanentemente el idioma de airmise-ng al actual"
	arr["FRENCH",447]="5.  Etablir comme langue permanente d'airmise-ng celle utilisée actuellement"
	arr["CATALAN",447]="5.  Canviar permanentment l'idioma de airmise-ng a l'actual"
	arr["PORTUGUESE",447]="5.  Alterar permanentemente o idioma do airmise-ng para o atual"
	arr["RUSSIAN",447]="5.  Сделать текущий язык airmise-ng постоянным"
	arr["GREEK",447]="5.  Θέστε μόνιμα την τρέχουσα γλώσσα του airmise-ng ως προεπιλεγμένη"
	arr["ITALIAN",447]="5.  Modificare in modo permanente la lingua di airmise-ng a quella attuale"

	arr["ENGLISH",448]="If you installed airmise-ng from a repository, you should not enable automatic updates. airmise-ng will be updated when there is a new version in the repository"
	arr["SPANISH",448]="Si instalaste airmise-ng desde un repositorio, no deberías activar la actualización automática. airmise-ng se actualizará cuando haya una nueva versión en el repositorio"
	arr["FRENCH",448]="Si vous avez installé airmise-ng depuis des dêpots vous devriez ne pas activer les mises à jour automatiques. airmise-ng sera mis à jour quand une nouvelle version sera disponible dans vos dépôts"
	arr["CATALAN",448]="Si vas instal·lar airmise-ng des d'un repositori, no hauries d'activar l'actualització automàtica. airmise-ng s'actualitzarà quan hi hagi una nova versió al repositori"
	arr["PORTUGUESE",448]="Se você instalou airmise-ng partir de um repositório, você não deve ativar a atualização automática. airmise-ng será atualizado quando houvér nova versão no repositório"
	arr["RUSSIAN",448]="Если вы установили airmise-ng из репозитория, вам не следует включать автоматические обновления. airmise-ng будет обновляться, когда в репозитории будет новая версия"
	arr["GREEK",448]="Αν εγκαταστήσατε το airmise-ng από κάποιο επίσημο αποθετήριο, δεν θα πρέπει να ενεργοποιήσετε τις αυτόματες ενημερώσεις. Το airmise-ng θα ενημερωθεί όταν υπάρξει κάποια νέα έκδοση στο επίσημο αποθετήριο"
	arr["ITALIAN",448]="Se è stato installato airmise-ng da un repository, non si dovrebbe attivare l'aggiornamento automatico. airmise-ng sará aggiornato quando ci sará una nuova versione nel repository"
	...
	arr["ENGLISH",459]="If you installed airmise-ng from a repository you shouldn't enable this option. airmise-ng will be updated when the repositories do. If you continue, make sure you know what you are doing, or you could cause problems with update flow"
	arr["SPANISH",459]="Si instalaste airmise-ng desde un repositorio no deberías activar esta opción. airmise-ng se actualizará cuando lo hagan los repositorios. Si continuas, asegúrate de saber bien lo que haces o podrías causar problemas con flujo de actualizaciones"
	arr["FRENCH",459]="Si airmise-ng a été installé depuis des dépôts vous devriez ne pas activer cette option. airmise-ng sera mis à jour automatiquement en passant par vos dépôts. Si vous décidez de continuer soyez conscient du fait que vous pourriez générer ainsi des conflits lors de futures actualisations système"
	arr["CATALAN",459]="Si vas instal·lar airmise-ng des d'un repositori no hauries d'activar aquesta opció. airmise-ng s'actualitzarà quan ho facin els repositoris. Si continues, assegura't de saber bé el que fas o podries causar problemes amb flux d'actualitzacions"
	arr["PORTUGUESE",459]="Se você instalou airmise-ng a partir de um repositório você não deve ativar essa opção. airmise-ng será atualizado quando você estiver disponivel nos repositórios. Se você continuar, verifique se você sabe o que está fazendo ou ou você pode causar problemas com o fluxo de atualização"
	arr["RUSSIAN",459]="Если вы установили airmise-ng из репозитория, вы не должны включать эту опцию. airmise-ng будет обновляться вместе с репозиториями. Если вы продолжите, убедитесь, что знаете, что делаете, или ваши действия могут вызвать проблемы для этой программы"
	arr["GREEK",459]="Εάν εγκαταστήσατε το airmise-ng από κάποιο επίσημο αποθετήριο, δεν πρέπει να ενεργοποιήσετε αυτή την επιλογή. Το airmise-ng θα ενημερωθεί όταν ενημερωθούν και τα αποθετήρια. Αν συνεχίσετε, βεβαιωθείτε ότι γνωρίζετε τι κάνετε και ότι θα μπορεί να προκαλέσετε προβλήματα με τη ροή ενημέρωσης"
	arr["ITALIAN",459]="Se airmise-ng è stato installato da un repository non si dovrebbe attivare questa opzione. airmise-ng sará aggiornato quando lo faranno i repository. Se continui, assicurati di sapere bene quello che fai o potrebbe causare problemi al flusso degli aggiornamenti"
	...
	arr["ENGLISH",476]="A graphical X window system has not been detected. If you already have one, check it's working properly. It's essential for airmise-ng. The script can't continue"
	arr["SPANISH",476]="No se ha detectado un sistema gráfico de ventanas X. Si lo tienes, comprueba su que esté funcionando correctamente. Es esencial para airmise-ng. El script no puede continuar"
	...
	arr["CATALAN",476]="No s'ha detectat un sistema gràfic de finestres X. Si el tens, comprova que estigui funcionant correctament. És essencial per a airmise-ng. El script no pot continuar"
	arr["PORTUGUESE",476]="Não foi detectado um sistema X Window (interface grafica). Se você possui, verifique se está funcionando corretamente. É essencial para airmise-ng. O script não pode continuar"
	arr["RUSSIAN",476]="Графическая X система не обнаружена. Если она уже имеется, проверьте её работоспособность. Это важно для airmise-ng. Скрипт не может продолжить"
	arr["GREEK",476]="Δεν έχει εντοπιστεί κάποιο γραφικό σύστημα παραθύρων X. Αν έχετε ήδη ένα, ελέγξτε ότι λειτουργεί σωστά. Είναι απαραίτητο για το airmise-ng. Το script δεν μπορεί να συνεχίσει"
	arr["ITALIAN",476]="Non è stato rilevato un server X grafico, se è presente controllare il corretto funzionamento. È essenziale per airmise-ng. Lo script non può continuare"

	arr["ENGLISH",477]="The options in this menu containing the word \"permanently\" modify airmise-ng to save the settings for the next time that is to be launched. However, you can always return to this menu to change the value of the option again"
	arr["SPANISH",477]="Las opciones de este menú que contienen la palabra \"permanentemente\", modifican airmise-ng para que incluso la siguiente vez que sea iniciado siga guardando la configuración. No obstante, siempre puedes volver a este menú a cambiar de nuevo el valor de la opción"
	arr["FRENCH",477]="Les options contenant le mot \"permanente\" modifiént airmise-ng de sorte que les paramétrages persisteront lors des prochains redémarrages. Vous pourrez cependant toujours modifier la configuration permanante depuis ce même menu"
	arr["CATALAN",477]="Les opcions d'aquest menú que contenen la paraula \"permanentment\", modifiquen airmise-ng perquè fins i tot la següent vegada que sigui iniciat segueixi guardant la configuració. No obstant això, sempre pots tornar a aquest menú a canviar de nou el valor de l'opció"
	arr["PORTUGUESE",477]="As opções neste menu contendo a palavra \"permanentemente\" serão modificadas de modo que mesmo no próximo inicio do airmise-ng as configuração serão mantidas. No entanto, você pode sempre voltar a este menu e alterar as opções"
	arr["RUSSIAN",477]="Опции в этом меню, содержащие слово \"постоянное\", сохраняются в airmise-ng при перезапусках программы. Однако вы всегда можете вернуться в это меню, чтобы снова изменить значение параметра"
	arr["GREEK",477]="Οι επιλογές σε αυτό το μενού που περιέχουν τη λέξη \"μόνιμα\" τροποποιούν το airmise-ng ώστε να αποθηκεύει τις ρυθμίσεις για την επόμενη φορά. Ωστόσο, μπορείτε πάντα να επιστρέψετε σε αυτό το μενού για να αλλάξετε ξανά την τιμή της επιλογής"
	arr["ITALIAN",477]="Le opzioni di questo menú che contengono la parola \"permanentemente\" modificano airmise-ng in modo che anche la volta successiva che viene avviato continui con la configurazione salvata. Tuttavia, si può sempre tornare a questo menú per cambiare di nuovo il valore dell'opzione"

	arr["ENGLISH",478]="${blue_color}Language is going to be set permanently to the current one, so on the next start of airmise-ng it will be used directly. ${green_color}Do you want to continue? ${normal_color}${visual_choice}"
	arr["SPANISH",478]="${blue_color}Se va a cambiar permanentemente el idioma al actual para que al siguiente inicio de airmise-ng este sea el idioma en el que arranque directamente. ${green_color}¿Deseas continuar? ${normal_color}${visual_choice}"
	arr["FRENCH",478]="${blue_color}La langue actuelle va être activée de façon permanente, c'est à dire que ce sera la langue d'usage lors des prochains démarrages d'airmise-ng. ${green_color}Voulez-vous continuer? ${normal_color}${visual_choice}"
	arr["CATALAN",478]="${blue_color}Es canviarà permanentment l'idioma a l'actual perquè al següent inici d' airmise-ng aquest sigui l'idioma en què arrenqui directament. ${green_color}¿Vols continuar? ${normal_color}${visual_choice}"
	arr["PORTUGUESE",478]="${blue_color}A linguagem será definida permanentemente para a atual, no próximo início do airmise-ng esta será a usada linguagem. ${green_color}Você deseja continuar? ${normal_color}${visual_choice}"
	arr["RUSSIAN",478]="${blue_color}Текущий язык будет установлен как постоянный, поэтому при следующем запуске airmise-ng он будет использоваться без определения языка системы. ${green_color}Вы хотите продолжить? ${normal_color}${visual_choice}"
	arr["GREEK",478]="${blue_color}Η τρέχουσα γλώσσα πρόκειται να τεθεί μόνιμα ως προεπιλεγμένη, ώστε κατά την επόμενη εκκίνηση του airmise-ng θα χρησιμοποιηθεί κατ' ευθείαν αυτή. ${green_color}Θέλετε να συνεχίσετε; ${normal_color}${visual_choice}"
	arr["ITALIAN",478]="${blue_color}Sarà modificata in modo permanente la lingua corrente in modo che al prossimo avvio di airmise-ng questa sia la lingua di avvio. ${green_color}Vuoi continuare? ${normal_color}${visual_choice}"
